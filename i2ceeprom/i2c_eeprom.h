...
//#define slaveAddressVar 0b001 //Переменная часть адреса ведомого устройства
...
//#define HW_BLOCK_0 0b10100000
//#define HW_BLOCK_1 0b10100010
...
uint8_t eeWriteByte(uint16_t address,uint8_t data, uint16_t HW_BLOCK); //Запись байта в модуль памяти EEPROM
uint8_t eeReadByte(uint16_t address, uint16_t HW_BLOCK); //Чтение байта из модуля памяти EEPROM
